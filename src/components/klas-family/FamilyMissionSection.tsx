...
export default function FamilyMissionSection() {
  ...
  return (
    <section ref={sectionRef} className="section">
      <div className="container">
        <div className="grid">
          {/* Left Content Column */}
          <div className={`leftCol ${isVisible ? 'animatedIn' : ''}`}>
            <h2 className="title">Our Mission</h2>
            <p className="description">
              To preserve and grow the family capital through thoughtful stewardship,
              rigorous investment discipline, prudence, and a commitment to
              sustainable long-term value creation.
            </p>
          </div>

          {/* Right Line Divider Column with Bullet Dot */}
          <div className={`rightCol ${isVisible ? 'animatedInDelay' : ''}`}>
      ...
      <style jsx>{`
        ...
        .rightCol.animatedInDelay {
          opacity: 1;
          transform: translateX(0);
        }

        .rightCol.animatedInDelay .dividerLine {
          opacity: 1;
          transform: translateX(0);
        }
